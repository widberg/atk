...
const n = {
  fuel: () => {
    ...
    var t, a, r = !1, c = "a1 ?? ?? ?? ?? d9 05 ?? ?? 9d 00 6a 00 d9 1d ?? ?? a7 00 68 ?? ?? 9c 00 50 c6 05 ?? ?? a7 00 00 e8 3a 13 01 00 83 05 ?? ?? a7 00 01 80 3d 79 ?? a6 00 00 75 f7 e8 85 f9 ff ff e8 ?? 71 19 00 84 c0", l = Memory.scanSync(n.base, n.size, c);
    if (0 != l.length) t = l[0].address.add(1).readPointer(); else {
      ...
      t = new NativePointer("0x00a754e0"), r = !0;
    }
    ...
    Interceptor.attach(a, {
      onEnter: e => {
        o && console.log(e[1].readUtf8String());
      }
    }), global.runCommand = e => {
      a(t.readPointer(), Memory.allocUtf8String(e), 0);
    };
  ...
  "wall-e": () => {
    ...
    var t = n.base.add(9627448).sub(4194304), a = new NativeFunction(n.base.add(4679040).sub(4194304), "bool", [ "pointer", "pointer", "uint32" ], "thiscall");
    Interceptor.attach(a, {
      onEnter: e => {
        o && console.log(e[0].readUtf8String());
      }
    }), global.runCommand = e => {
      a(t.readPointer(), Memory.allocUtf8String(e), 0);
    };
  ...
  overlay: () => {
    const n = Process.enumerateModules()[0];
    for (const e of Process.enumerateModules()) Memory.protect(e.base, e.size, "rwx");
    var t = "b8 0c 44 00 00 e8 d6 8b 0f 00 a1 60 6d 79 00 33 84 24 0c 44 00 00 53 55 89 84 24 10 44 00 00 8b e9 8d 84 24 10 04 00 00 b9 10 00 00 00 8d 49 00 c6 00 00 05 00 04 00 00 49 75 f5 8b 9c 24 18 44", a = Memory.scanSync(n.base, n.size, t);
    ...
    } else if (t = "8b 44 24 08 8b 54 24 04 8b 89 0c 29 00 00 50 52 e8 ab d6 09 00 c2 08 00 90 90 90 90 90 90 90 90 8b 44 24 08 8b 54 24 04 8b 89 0c 29 00 00 50 52 e8 2b d8 09 00 c2 08 00 90 90 90 90 90 90 90 90", 
    0 != (a = Memory.scanSync(n.base, n.size, t)).length && a[0].address.equals(new NativePointer("0x0054B420"))) {
    ...
    } else if (t = "4d 55 4d 4d 59 00 00 00 42 4c 4f 43 4b 33 00 00 42 4c 4f 43 4b 32 00 00 42 4c 4f 43 4b 31 00 00 42 4c 4f 43 4b 30 00 00 54 68 65 20 4d 75 6d 6d 79 00 00 00 35 32 38 33 35 00 00 00", 
    0 != (a = Memory.scanSync(n.base, n.size, t)).length) {
      ...
      if (0 == (f = Memory.scanSync(n.base, n.size, s)).length) return void console.log("Could not locate the nppGlobalCommandState. Aborting...");
      ...
      if (0 == (m = Memory.scanSync(n.base, n.size, i)).length) return void console.log("Could not locate the nfRunCommand. Aborting...");
    ...
    } else if (t = "44 55 43 4b 00 00 00 00 42 4c 4f 43 4b 33 00 00 42 4c 4f 43 4b 32 00 00 42 4c 4f 43 4b 31 00 00 42 4c 4f 43 4b 30 00 00 53 69 74 74 69 6e 67 44 75 63 6b 73 00 00 00 00 35 32 31 31 36 00 00 00", 
    0 != (a = Memory.scanSync(n.base, n.size, t)).length) {
      ...
      if (0 != (f = Memory.scanSync(n.base, n.size, s)).length) r = f[0].address.add(2).readPointer(); else {
        ...
        0 == (f = Memory.scanSync(n.base, n.size, s)).length) return void console.log("Could not locate the nppGlobalCommandState. Aborting...");
      ...
      if (0 != (m = Memory.scanSync(n.base, n.size, i)).length) c = new NativeFunction(m[0].address, "bool", [ "pointer", "pointer", "uint32" ], "thiscall"); else {
      ...
      if (0 != h.length) d = h[0].address.add(1); else {
  ...
  up: () => {
    const n = Process.enumerateModules()[0];
    for (const e of Process.enumerateModules()) Memory.protect(e.base, e.size, "rwx");
    var t, a = Memory.scanSync(n.base, n.size, "8b 0d c8 cc a7 00 6a 00 d9 1d b0 df a7 00 68 5c 78 9e 00 c6 05 b8 df a7 00 00 e8 da 9c f9 ff 83 05 a8 df a7 00 01 80 3d 88 7c a6 00 00 75 f7 e8 b5 f9 ff ff e8 b0 60 17 00 84 c0 74 e9 e8 f7 08");
    0 != a.length && a[0].address.equals(new NativePointer("0x00482387")) ? (console.log("UP RU"), 
    t = new NativePointer("0x00a7ccc8")) : (console.log("UP US"), t = new NativePointer("0x00a7ccb0"));
  ...
  aplaguetaleinnocence_x64: () => {
    const n = Process.enumerateModules()[0];
    for (const e of Process.enumerateModules()) Memory.protect(e.base, e.size, "rwx");
    var t, a = Memory.scanSync(n.base, n.size, "48 8b 0d ?? ?? bb 00 4c 8d 9c 24 f0 00 00 00 49 8b 5b 38 49 8b 6b 40 49 8b 73 48 49 8b e3 41 5f 41 5e 41 5d 41 5c 5f e9 ?? ?? dc ff cc cc cc cc cc cc cc cc cc 48 8b c4 55 57 41 54 41 56 41 57");
    if (0 != a.length) {
      var r, c = a[0].address, l = c.add(3).readU32();
      t = c.add(l + 7);
      ...
      if (0 != d.length) {
        ...
        Interceptor.attach(r, {
          onEnter: e => {
            o && console.log(this.context.rdx.readUtf8String());
          }
        }), global.runCommand = e => {
          r(t.readPointer(), Memory.allocUtf8String(e), 0);
        };
...
var t = n[Process.enumerateModules()[0].name.toLowerCase().split(".")[0]];
