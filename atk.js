...
const n = {
  fuel: () => {
    ...
    var a, t, c = !1, r = "a1 ?? ?? ?? ?? d9 05 ?? ?? 9d 00 6a 00 d9 1d ?? ?? a7 00 68 ?? ?? 9c 00 50 c6 05 ?? ?? a7 00 00 e8 3a 13 01 00 83 05 ?? ?? a7 00 01 80 3d 79 ?? a6 00 00 75 f7 e8 85 f9 ff ff e8 ?? 71 19 00 84 c0", l = Memory.scanSync(n.base, n.size, r);
    if (0 != l.length) a = l[0].address.add(1).readPointer(); else {
      ...
      0 == (l = Memory.scanSync(n.base, n.size, r)).length) return void console.log("Could not locate the nppGlobalCommandState. Aborting...");
      a = new NativePointer("0x00a754e0"), c = !0;
    }
    ...
    if (0 != s.length) t = new NativeFunction(s[0].address, "bool", [ "pointer", "pointer", "uint32" ], "stdcall"); else {
      if (!c) return void console.log("Could not locate the nfRunCommand. Aborting...");
    ...
    if (0 != i.length) d = i[0].address; else {
      if (!c) return void console.log("Could not locate the npRegisterCommand. Aborting...");
  ...
  "wall-e": () => {
    ...
    var c, r = n.base.add(4678576).sub(4194304);
    ...
    0 != l.length ? (c = l[0].address.add(22), global.enableDPadCheats = () => {
      c.writeU8(67);
  ...
  overlay: () => {
    ...
    if (0 != t.length && t[0].address.equals(new NativePointer("0x0052e8b0"))) {
      var c = new NativePointer("0x007b2f9c"), r = new NativeFunction(new NativePointer("0x0052e8b0"), "bool", [ "pointer", "pointer", "uint32" ], "thiscall");
      Interceptor.attach(r, {
        onEnter: e => {
          o && (this.command_line = e[0].readAnsiString());
        },
        ...
        r(c.readPointer(), Memory.allocUtf8String(e), 0);
      };
    ...
    0 != (t = Memory.scanSync(n.base, n.size, a)).length && t[0].address.equals(new NativePointer("0x0054B420"))) {
      c = new NativePointer("0x00724414"), r = new NativeFunction(new NativePointer("0x0054B420"), "bool", [ "pointer", "pointer", "uint32" ], "thiscall");
      Interceptor.attach(r, {
        onEnter: e => {
          o && (this.command_line = e[0].readAnsiString());
        },
    ...
    0 != (t = Memory.scanSync(n.base, n.size, a)).length) {
      ...
      c = m[0].address.add(2).readPointer();
      ...
      r = new NativeFunction(u[0].address, "bool", [ "pointer", "pointer", "uint32" ], "thiscall"), 
      Interceptor.attach(r, {
        onEnter: e => {
          o && (this.command_line = e[0].readAnsiString());
        },
    ...
    0 != (t = Memory.scanSync(n.base, n.size, a)).length) {
      ...
      if (0 != (m = Memory.scanSync(n.base, n.size, s)).length) c = m[0].address.add(2).readPointer(); else {
        ...
        c = new NativePointer("0x007812b8"), g = !0;
      }
      var u;
      ...
      if (0 != (u = Memory.scanSync(n.base, n.size, i)).length) r = new NativeFunction(u[0].address, "bool", [ "pointer", "pointer", "uint32" ], "thiscall"); else {
  ...
  up: () => {
    ...
    var c = new NativeFunction(new NativePointer("0x0041c080"), "bool", [ "pointer", "pointer", "uint32" ], "thiscall");
    Interceptor.attach(c, {
      ...
      c(a.readPointer(), Memory.allocUtf8String(e), 0);
    };
  ...
  csr: () => {
    const n = Process.enumerateModules()[0];
    for (const e of Process.enumerateModules()) Memory.protect(e.base, e.size, "rwx");
    var a, t, c = !1, r = "8b 0d 20 84 5b 00 68 9c 6d 59 00 e8 de 06 fc ff a0 24 ed 5b 00 84 c0 75 f7 a1 34 84 5b 00 8b 0d 28 84 5b 00 83 c0 20 50 e8 f1 ae fb ff 85 c0 74 1c 8b 0d 28 84 5b 00 83 c0 58 50 e8 de ae fb ff", l = Memory.scanSync(n.base, n.size, r);
    if (0 != l.length) a = l[0].address.add(2).readPointer(); else {
      if (r = "8b 0d 50 e4 5a 00 68 10 cd 58 00 e8 8e 23 fc ff 8b 0d 64 e4 5a 00 8b 11 ff 52 40 8d 49 00 a0 64 4c 5b 00 84 c0 75 f7 a1 64 e4 5a 00 8b 0d 58 e4 5a 00 83 c0 20 50 e8 33 d1 fb ff 85 c0 74 1c 8b", 
      0 == (l = Memory.scanSync(n.base, n.size, r)).length) return void console.log("Could not locate the nppGlobalCommandState. Aborting...");
      a = new NativePointer("0x005AE450"), c = !0;
    }
  ...
  launch: () => {
    ...
    if (0 != t.length) {
      ...
      var r = Memory.scanSync(n.base, n.size, "81 ec 8c 08 00 00 a1 64 ea 67 00 33 c4 89 84 24 88 08 00 00 53 8b 9c 24 94 08 00 00 57 8b f9 89 5c 24 0c c6 44 24 10 00 8d 84 24 90 00 00 00 b9 0f 00 00 00 c6 00 00 05 80 00 00 00 83 e9 01 79");
      if (0 != r.length) {
        var l;
        c = new NativeFunction(r[0].address, "bool", [ "pointer", "pointer" ], "thiscall"), 
        Interceptor.attach(c, {
          onEnter: e => {
            o && (this.command_line = e[0].readAnsiString());
          },
          ...
          c(a.readPointer(), Memory.allocUtf8String(e));
        };
  ...
  ugly: () => {
    const n = Process.enumerateModules()[0];
    for (const e of Process.enumerateModules()) Memory.protect(e.base, e.size, "rwx");
    var a, t = Memory.scanSync(n.base, n.size, "8b 0d c8 d8 64 00 68 40 1a 62 00 e8 3e 89 fb ff 8b 0d dc d8 64 00 8b 11 ff 52 40 8d 49 00 a0 28 46 65 00 84 c0 75 f7 a1 dc d8 64 00 8b 0d d0 d8 64 00 83 c0 20 50 e8 23 37 fb ff 85 c0 74 1c 8b");
    if (0 != t.length) {
      var c;
      a = t[0].address.add(2).readPointer();
      var r = Memory.scanSync(n.base, n.size, "81 ec 88 08 00 00 a1 18 25 65 00 53 8b 9c 24 90 08 00 00 89 84 24 88 08 00 00 8b c3 57 8b f9 8d 50 01 8a 08 40 84 c9 75 f9 2b c2 89 44 24 08 75 19 5f 32 c0 5b 8b 8c 24 84 08 00 00 e8 b2 ba 0c");
      if (0 != r.length) {
        var l;
        c = new NativeFunction(r[0].address, "bool", [ "pointer", "pointer" ], "thiscall"), 
        Interceptor.attach(c, {
        ...
        var d = Memory.scanSync(n.base, n.size, "51 53 55 56 57 8b d9 68 dc 00 00 00 89 5c 24 14 e8 25 bc 0c 00 33 f6 83 c4 04 3b c6 74 16 89 b0 d4 00 00 00 89 b0 d8 00 00 00 89 b0 d0 00 00 00 8b e8 eb 02 33 ed 8b 7c 24 18 8b d7 8b c5 2b d5");
        0 != d.length ? (l = d[0].address, Interceptor.attach(l, {
          onEnter: o => {
            e.push(o[0].readAnsiString());
          }
  ...
  aplaguetaleinnocence_x64: () => {
    ...
    if (0 != t.length) {
      var c, r = t[0].address, l = r.add(3).readU32();
      a = r.add(l + 7);
      ...
      if (0 != d.length) {
        var s;
        c = new NativeFunction(d[0].address, "bool", [ "pointer", "pointer", "int64" ], "win64"), 
        Interceptor.attach(c, {
          onEnter: e => {
