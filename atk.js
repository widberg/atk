...
const o = {
  fuel: () => {
    ...
    var c, i = Memory.scanSync(o.base, o.size, "b8 0c 80 00 00 e8 ?? ?? 21 00 8b 94 24 14 80 00 00 53 56 57 8b bc 24 1c 80 00 00 8d 44 24 18 b9 1f 00 00 00 33 db 88 18 05 00 04 00 00 83 e9 01 79 f4 8b c2 8d 70 01 8a 08 83 c0 01 84 c9 75 f7");
    ...
    if (0 != s.length) c = s[0].address; else {
      if (!t) return void console.log("Could not locate the npRegisterCommand. Aborting...");
      c = new NativePointer("0x0069b610");
    }
    if (Interceptor.attach(c, {
      onEnter: o => {
      ...
      var d = Process.findModuleByName("xlive.dll");
      if (d) {
        Memory.protect(d.base, d.size, "rwx");
        var b = Memory.scanSync(d.base, d.size, "8b ff 55 8b ec 83 ec 20 53 56 57 8d 45 e0 33 f6 50 ff 75 0c 8b f9 8b 4d 08 89 75 e0 89 75 e4 89");
  ...
  "wall-e": () => {
    ...
    var l = Memory.scanSync(o.base, o.size, "50 41 54 43 48 5f 46 4c 41 47 53 5f 70 5f 44 5f 62 5f 4c 5f 4d 5f 63");
    0 != l.length ? (t = l[0].address.add(22), global.enableDPadCheats = () => {
      t.writeU8(67);
  ...
  overlay: () => {
    ...
    if (0 != a.length && a[0].address.equals(new NativePointer("0x0052e8b0"))) {
      ...
      var c = new NativePointer("0x005EBAED").add(1);
    ...
    0 != (a = Memory.scanSync(o.base, o.size, n)).length && a[0].address.equals(new NativePointer("0x0054B420"))) {
      ...
      c = new NativePointer("0x0060AE7D").add(1);
      global.enableContextMenu = () => {
        c.writeU8(0);
      }, global.disableContextMenu = () => {
        c.writeU8(86);
    ...
    0 != (a = Memory.scanSync(o.base, o.size, n)).length) {
      ...
      if (0 == (b = Memory.scanSync(o.base, o.size, i)).length) return void console.log("Could not locate the nppGlobalCommandState. Aborting...");
      t = b[0].address.add(2).readPointer();
      var s = "8b 44 24 08 8b 54 24 04 8b 89 10 29 00 00 50 52 e8 ?? ?? 08 00 c2 08 00 90 90 90 90 90 90 90 90 8b 44 24 04 8b 89 10 29 00 00 50 e8 ?? ?? 08 00 c2 04 00 90 90 90 90 90 90 90 90 90 90 90 90 90";
      if (0 == (m = Memory.scanSync(o.base, o.size, s)).length) return void console.log("Could not locate the nfRunCommand. Aborting...");
      r = new NativeFunction(m[0].address, "bool", [ "pointer", "pointer", "uint32" ], "thiscall"), 
      global.runCommand = e => {
        r(t.readPointer(), Memory.allocUtf8String(e), 0);
      };
      var d = "83 ec 14 55 56 57 6a 1b 68 ?? ?? 6a 00 68 58 e0 69 00 89 4c 24 18 6a 10 e8 ?? ee fe ff 33 f6 83 c4 10 3b c6 74 0f 89 30 89 70 04 89 70 0c 89 70 08 8b e8 eb 02 33 ed 53 8b 5c 24 28 53 e8 5e 7d";
      if (0 == (u = Memory.scanSync(o.base, o.size, d)).length) return void console.log("Could not locate the npRegisterCommand. Aborting...");
      ...
      if (0 != (b = Memory.scanSync(o.base, o.size, i)).length) t = b[0].address.add(2).readPointer(); else {
        ...
        0 == (b = Memory.scanSync(o.base, o.size, i)).length) return void console.log("Could not locate the nppGlobalCommandState. Aborting...");
        t = new NativePointer("0x007812b8"), f = !0;
      }
      var m;
      s = "b8 10 40 00 00 e8 ?? ?? ?? 00 a1 ?? ?? 7c 00 33 c4 89 84 24 0c 40 00 00 55 57 8b bc 24 1c 40 00 00 8b e9 89 7c 24 08 8d 44 24 14 b9 0f 00 00 00 c6 00 00 05 00 04 00 00 83 e9 01 79 f3 8b c7 8d";
      if (0 != (m = Memory.scanSync(o.base, o.size, s)).length) r = new NativeFunction(m[0].address, "bool", [ "pointer", "pointer", "uint32" ], "thiscall"); else {
      ...
      var u;
      d = "83 ec 18 a1 ?? ?? 7c 00 33 c4 89 44 24 14 53 55 8b 6c 24 24 57 6a 1a 68 ?? ?? 72 00 68 ?? ?? ?? 00 6a 10 89 4c 24 1c e8 ?? ?? fc ff 33 db 83 c4 10 3b c3 74 0f 89 18 89 58 04 89 58 0c 89 58 08";
      if (0 != (u = Memory.scanSync(o.base, o.size, d)).length) l = u[0].address; else {
      ...
      if (0 != g.length) c = g[0].address.add(1); else {
        if (!f) return void console.log("Could not locate the npModernPopupMenuCondition. Aborting...");
        c = new NativePointer("0x006051fd").add(1);
      }
      global.enableContextMenu = () => {
        c.writeU8(0);
      }, global.disableContextMenu = () => {
        f ? c.writeU8(84) : c.writeU8(83);
      };
    }
  },
  overlay_win2k: () => {
