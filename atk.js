...
const n = {
  fuel: () => {
    ...
    var a, t, r = !1, l = "a1 ?? ?? ?? ?? d9 05 ?? ?? 9d 00 6a 00 d9 1d ?? ?? a7 00 68 ?? ?? 9c 00 50 c6 05 ?? ?? a7 00 00 e8 3a 13 01 00 83 05 ?? ?? a7 00 01 80 3d 79 ?? a6 00 00 75 f7 e8 85 f9 ff ff e8 ?? 71 19 00 84 c0", c = Memory.scanSync(n.base, n.size, l);
    if (0 != c.length) a = c[0].address.add(1).readPointer(); else {
      ...
      0 == (c = Memory.scanSync(n.base, n.size, l)).length) return void console.log("Could not locate the nppGlobalCommandState. Aborting...");
  ...
  "wall-e": () => {
    ...
    var r, l = n.base.add(4678576).sub(4194304);
    ...
    var c = Memory.scanSync(n.base, n.size, "50 41 54 43 48 5f 46 4c 41 47 53 5f 70 5f 44 5f 62 5f 4c 5f 4d 5f 63");
    0 != c.length ? (r = c[0].address.add(22), global.enableDPadCheats = () => {
      r.writeU8(67);
  ...
  overlay: () => {
    ...
    0 != (t = Memory.scanSync(n.base, n.size, a)).length) {
      ...
      l = new NativeFunction(g[0].address, "bool", [ "pointer", "pointer", "uint32" ], "thiscall"), 
      Interceptor.attach(l, {
        onEnter: e => {
          o && (this.command_line = e[0].readAnsiString());
        },
    ...
    0 != (t = Memory.scanSync(n.base, n.size, a)).length) {
      ...
      s = new NativePointer("0x005D5C94");
      global.enableContextMenu = () => {
        flags = s.readU32(), s.writeU32(4 | flags);
      }, global.disableContextMenu = () => {
        flags = s.readU32(), s.writeU32(-5 & flags);
      };
    } else {
      var f, m = !1;
      ...
      if (0 != (g = Memory.scanSync(n.base, n.size, d)).length) l = new NativeFunction(g[0].address, "bool", [ "pointer", "pointer", "uint32" ], "thiscall"); else {
      ...
      if (0 != (u = Memory.scanSync(n.base, n.size, b)).length) c = u[0].address; else {
  ...
  aplaguetaleinnocence_x64: () => {
    ...
    if (0 != t.length) {
      var r, l = t[0].address, c = l.add(3).readU32();
      a = l.add(c + 7);
