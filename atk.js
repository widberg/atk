...
const o = {
  ...
  overlay: () => {
    ...
    0 != (a = Memory.scanSync(o.base, o.size, n)).length) {
      ...
      if (0 == (b = Memory.scanSync(o.base, o.size, d)).length) return void console.log("Could not locate the nppGlobalCommandState. Aborting...");
      t = b[0].address.add(2).readPointer();
      s = "8b 44 24 08 8b 54 24 04 8b 89 10 ?? 00 00 50 52 e8 bb ?? 07 00 c2 08 00 90 90 90 90 90 90 90 90 8b 81 10 ?? 00 00 8b 40 20 c3 90 90 90 90 90 90 b8 cc ?? 00 00 e8 ?? ?? 0d 00 53 55 56 8b b4 24";
      if (0 == (m = Memory.scanSync(o.base, o.size, s)).length) return void console.log("Could not locate the nfRunCommand. Aborting...");
      r = new NativeFunction(m[0].address, "bool", [ "pointer", "pointer", "uint32" ], "thiscall"), 
      global.runCommand = e => {
        r(t.readPointer(), Memory.allocUtf8String(e), 0);
      ...
      if (0 != (u = Memory.scanSync(o.base, o.size, i)).length) c = u[0].address; else {
  ...
  aplaguetaleinnocence_x64: () => {
    ...
    if (0 != a.length) {
      var t, r = a[0].address, c = r.add(3).readU32();
      n = r.add(c + 7);
      ...
      if (0 != l.length) {
        var d;
        t = new NativeFunction(l[0].address, "bool", [ "pointer", "pointer", "int64" ], "win64"), 
        global.runCommand = e => {
          t(n.readPointer(), Memory.allocUtf8String(e), 0);
        };
        var s = Memory.scanSync(o.base, o.size, "48 89 5c 24 18 55 56 57 41 54 41 55 41 56 41 57 48 83 ec 40 4d 8b e0 48 8b ea 48 8b f9 48 85 d2 74 16 4c 8b 05 ?? ?? df 00 48 8d 8c 24 80 00 00 00 e8 ?? ?? f2 ff eb 17 48 8b 05 ?? ?? df 00 48");
